...
const TicketBooking = () => {
  ...
  const [movieSeats,dispatchMovieSeats]=useReducer(seatReducer,new Map());
  ...
  return (
    <Container>
      ...
      <Grid>
        ...
        <BuyTicketsButton
                onClick={() =>{ dispatchSeatState({ type: "purchase"});dispatchMovieSeats({type:"storeseats",payload1:movieid,payload2:seatState.purchasedSeat})}}
